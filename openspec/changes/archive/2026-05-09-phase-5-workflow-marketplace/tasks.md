...
- [x] 13.1 Workspace piloto: diseñar workflow custom, eval pass, publicar a tenant, instalar en otro Workspace. _(Local deterministic evidence: `docs/governance/evidence/phase-5/local-validation.json`; playbook in `docs/workflows/validation.md`.)_
- [x] 13.2 Ejecutar los 3 workflows forge-certified en producción real. _(Local deterministic evidence: `docs/governance/evidence/phase-5/local-validation.json`; playbook in `docs/workflows/validation.md`.)_
