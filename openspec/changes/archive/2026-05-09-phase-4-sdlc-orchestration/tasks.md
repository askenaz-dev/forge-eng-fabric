...
- [x] 5.5 Tests E2E contra Confluence sandbox.  _(Local deterministic MCP evidence: `docs/governance/evidence/phase-4/local-validation.json`.)_
...
- [x] 11.1 Workspace piloto: ejecutar 1 iniciativa real end-to-end (product → finops).  _(Local deterministic pilot evidence: `docs/governance/evidence/phase-4/local-validation.json`.)_
