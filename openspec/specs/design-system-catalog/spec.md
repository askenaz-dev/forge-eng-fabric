# design-system-catalog Specification

## Purpose

Registry, versioning, distribution and lifecycle for Design System assets — the
catalog of selectable token sheets, component packs and font preload lists that
Apps consume at build time. Created by archiving change `design-system-catalog`.
