# alfred-console-friendly Specification

## Purpose

Friendly view for the Alfred Console — a non-technical surface that hides slash-command knowledge, raw identifiers, and backend error codes, exposing instead three intent-landing cards, an App switcher, human-readable labels, a developer-mode toggle, and tenant-level default override. Created by archiving change `alfred-console-redesign`.
